...
import com.emi.plugins.levelplay.banner.BannerExecutor;
import com.emi.plugins.levelplay.consent.ConsentCallback;
import com.emi.plugins.levelplay.consent.ConsentProvider;
import com.emi.plugins.levelplay.consent.ConsentStatus;
import com.emi.plugins.levelplay.consent.CustomModalConsentProvider;
import com.emi.plugins.levelplay.interstitial.InterstitialExecutor;
import com.emi.plugins.levelplay.privacy.PrivacyExecutor;
import com.emi.plugins.levelplay.rewarded.RewardedExecutor;
...
public class LevelPlayAdsPlugin extends Plugin {
    ...
    public void load() {
        ...
        consentProvider = new CustomModalConsentProvider(getContext());
    ...
    /** Public wrapper letting executor classes emit Capacitor events. */
